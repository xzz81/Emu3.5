...
| --- | --- | --- | --- | --- | --- | --- |
| complex_proposed | 24 | 41.5000 | 5.0000 | 3.0000 | 52 | count_exact:7;negative_constraint:5;third_object:4;relation_binding:3;four_objects:2;occlusion:2;depth_order:2;attribute_binding:2;count_control:2;three_objects:1;relation_chain:1;vertical_order:1 |
...
```bash
RUN_ID=semantic_uncertainty_complex_t2i_emu35_20260611 \
NUM_CONCEPTS=24 T2I_SAMPLES=10 GEN_WORKERS=2 STRICT_WORKERS=2 QA_WORKERS=2 \
