...
for margin in MARGINS:
    for case_key, object_phrase, position_phrase in BASE_CASES:
        ...
        prompts[f"margindesc_{margin_case_key}__describe"] = {
            **common,
            "prompt": "Describe this image carefully.",
        }
        prompts[f"marginspatial_{margin_case_key}__spatialdescribe"] = {
            **common,
            "prompt": (
        ...
        prompts[f"marginimageonly_{margin_case_key}__imageonly"] = {
            **common,
            "prompt": "",
        }
