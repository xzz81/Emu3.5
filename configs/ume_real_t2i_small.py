...
prompts = {
    "attr_count_spatial": (
        "A square children's book illustration of a wooden table with exactly three ceramic mugs: "
        "one red mug on the left, one blue mug in the center, and one yellow mug on the right. "
        "A small green apple sits in front of the blue mug. Keep the background simple and uncluttered."
    ),
    "text_rendering_sign": (
        "A square close-up illustration of a clean white bakery sign hanging on a brick wall. "
        "The sign should contain the readable text SWEET BUNS in large dark letters. "
        "Add two croissants below the sign and warm morning light."
    ),
    "ambiguous_low_evidence": (
        "A square surreal but realistic scene showing the object from yesterday's important meeting "
        "on a small pedestal in a quiet museum room. Make the object visually specific even though "
        "the prompt gives very little evidence."
    ),
}
