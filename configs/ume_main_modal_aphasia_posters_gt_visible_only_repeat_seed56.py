...
"""Repeated visible-only prompt for real-poster GT readback."""
...
task_type = "modal_aphasia_poster_gt_visible_only_repeat"
...
for row in json.loads(MANIFEST.read_text(encoding="utf-8")):
    ...
    for rep in range(REPEATS):
        prompts[f"poster_{poster_id:02d}_{slug}_rep{rep:02d}__visible_only"] = {
            **base,
            "prompt": PROMPT,
            "prompt_variant": "visible_only",
            "repeat": rep,
        }
