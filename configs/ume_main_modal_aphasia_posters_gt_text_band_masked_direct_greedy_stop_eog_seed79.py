...
"""Greedy direct readback of masked posters, stopping at EOG continuation token."""
...
task_type = "modal_aphasia_poster_gt_text_band_masked_direct_greedy_stop_eog"
...
text_stop_after_token_names = ["EOG"]
...
for row in json.loads(MANIFEST.read_text(encoding="utf-8")):
    ...
    prompts[f"poster_{poster_id:02d}_{slug}__text_band_masked_direct_greedy_stop_eog"] = {
        ...
        "prompt": PROMPT,
        "prompt_variant": "text_band_masked_direct_greedy_stop_eog",
        "decoding": "greedy_stop_eog",
    }
