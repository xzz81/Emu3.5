...
"""Repeated readback of downloaded real poster GT images with two input forms."""
...
task_type = "modal_aphasia_poster_gt_readback_repeat"
...
for row in json.loads(MANIFEST.read_text(encoding="utf-8")):
    ...
    for rep in range(REPEATS):
        prompts[f"poster_{poster_id:02d}_{slug}_rep{rep:02d}__gt_describe"] = {
            **base,
            "prompt": "Describe this image carefully.",
            "input_form": "image_plus_text",
            "repeat": rep,
        }
        prompts[f"poster_{poster_id:02d}_{slug}_rep{rep:02d}__gt_imageonly"] = {
            **base,
            "prompt": "",
