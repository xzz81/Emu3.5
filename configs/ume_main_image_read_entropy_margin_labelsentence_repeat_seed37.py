    ...
    for margin in MARGINS:
        for case_key, object_phrase, position_phrase in BASE_CASES:
            ...
            prompt = (
                ...
                f"Format your answer like: The {object_phrase} is in the <location> part of the image."
            )
            prompts[f"marginlabelsentrep{rep:02d}_{margin_case_key}__labelsentence"] = {
                "prompt": prompt,
