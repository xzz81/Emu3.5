...
prompts = {
    "story_cloud_tree_car": (
        "Create a short interleaved visual story about a small red car parked beside a tall tree "
        "under a cloudy sky. Keep the objects consistent across the story."
    ),
    "story_lost_key": (
        "Create a short interleaved visual story about a brass key moving from a kitchen table "
        "to a blue backpack. Keep the key color and location changes explicit."
    ),
}
