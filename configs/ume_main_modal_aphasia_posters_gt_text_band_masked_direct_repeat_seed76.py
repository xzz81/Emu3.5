...
"""Repeated direct readback of text-band masked real-poster GT images."""
...
task_type = "modal_aphasia_poster_gt_text_band_masked_direct_repeat"
...
for row in json.loads(MANIFEST.read_text(encoding="utf-8")):
    ...
    for rep in range(REPEATS):
        prompts[f"poster_{poster_id:02d}_{slug}_rep{rep:02d}__text_band_masked_direct"] = {
            **base,
            "prompt": PROMPT,
            "prompt_variant": "text_band_masked_direct",
            "repeat": rep,
        }
