...
"""Real-poster GT readback with strict visible-only no-guess prompt."""
...
task_type = "modal_aphasia_poster_gt_strict_visible"
...
for row in json.loads(MANIFEST.read_text(encoding="utf-8")):
    ...
    for variant, prompt_text in PROMPTS.items():
        prompts[f"poster_{poster_id:02d}_{slug}__seed72_{variant}"] = {
            **base,
            "prompt": prompt_text,
