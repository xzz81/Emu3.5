...
"""Short greedy direct readback of text-band masked real-poster GT images."""
...
task_type = "modal_aphasia_poster_gt_text_band_masked_direct_greedy_short"
...
PROMPT = (
    "Describe the visible poster image in 3 concise sentences. "
    "Do not write steps, plans, reasoning, headings, translations, or meta commentary. "
...
for row in json.loads(MANIFEST.read_text(encoding="utf-8")):
    ...
    prompts[f"poster_{poster_id:02d}_{slug}__text_band_masked_direct_greedy_short"] = {
        ...
        "prompt": PROMPT,
        "prompt_variant": "text_band_masked_direct_greedy_short",
        "decoding": "greedy_short",
    }
