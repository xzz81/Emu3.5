#!/usr/bin/env python3
"""Build near-center target+distractor images with same shape but different color."""
...
OUT_DIR = Path("assets/ume_image_read_near_same_shape_distractor_seed32")
SIZE = 512
SHAPE_SIZE = 64
BG = (148, 148, 148)
OUTLINE = (30, 30, 30)

# Objects stay fully inside their quadrant, but close enough to remove the easy corner cue.
POSITIONS = {
    "upper-left": (168, 168),
    "upper-right": (280, 168),
    "lower-left": (168, 280),
...
def main() -> None:
    ...
    print(f"[INFO] wrote {len(rows)} near same-shape distractor images to {OUT_DIR}")
