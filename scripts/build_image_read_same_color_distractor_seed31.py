#!/usr/bin/env python3
"""Build target+distractor images where distractor has the same color but different shape."""
...
OUT_DIR = Path("assets/ume_image_read_same_color_distractor_seed31")
SIZE = 512
SHAPE_SIZE = 104
BG = (148, 148, 148)
OUTLINE = (30, 30, 30)
...
TARGETS = [
    ("red circle", "circle", (218, 38, 38), "red square", "square"),
    ("blue square", "square", (35, 95, 215), "blue triangle", "triangle"),
    ("yellow triangle", "triangle", (238, 204, 42), "yellow circle", "circle"),
]
...
def main() -> None:
    ...
    rows = []
    for object_phrase, kind, color, distractor_phrase, distractor_kind in TARGETS:
        ...
        for position_phrase in POSITIONS:
            ...
            draw_shape(draw, distractor_kind, bbox(distractor_position), color)
    ...
    print(f"[INFO] wrote {len(rows)} same-color distractor images to {OUT_DIR}")
