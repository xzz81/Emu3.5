#!/usr/bin/env python3
"""Build near-center single-object images for forced-position control."""
...
OUT_DIR = Path("assets/ume_image_read_near_single_object_seed33")
SIZE = 512
SHAPE_SIZE = 64
BG = (148, 148, 148)
OUTLINE = (30, 30, 30)
...
def main() -> None:
    ...
    print(f"[INFO] wrote {len(rows)} near single-object images to {OUT_DIR}")
